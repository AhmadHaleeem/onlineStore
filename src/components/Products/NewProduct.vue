    ...
    <v-layout row>
      <v-flex xs12 sm6 offset-sm3>
        ...
        <v-form ref="form" v-model="valid" lazy-validation class="mb-3">
          <v-text-field name="title" label="Title" type="text" required :rules="[v => !!v || 'Title is required']"
          ...
          <v-text-field name="price" label="Price Product" type="text" required
                        :rules="[v => !!v || 'Price is required']" v-model="price"></v-text-field>
          <v-text-field name="description" label="Description Product" type="text" multi-line v-model="description"></v-text-field>
        </v-form>
