<template>
  <v-container>
    <section class="product mt-3 elevation-3" v-if="!loading">
      <v-layout row wrap>
        <v-flex xs12 lg6>
        ...
        <v-flex xs12 lg6>
          <div class="product_info">
            ...
            <p class="product_category title">
              <span class="product_title">Vendor: </span>{{ product.vendor.charAt(0).toUpperCase() +
            ...
            <p class="title">
              <span class="product_title">Material: </span>{{ product.material.charAt(0).toUpperCase() +
